            ...
            <AppBar position="static" style={{ background: 'rgba(0,0,0,1)' }}>
                ...
                <Toolbar>
                    <Typography className={classes.title} style={{marginLeft: '40%'}}variant="h6"  noWrap>
                        <><span style={{color : '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '2em', }}>RONA</span> <span  style={{color : '#fe0023', fontFamily: 'Rajdhani', fontWeight: '100', fontSize: '1.3em', }}>  GOD'S EYE EDITION </span></>
                    </Typography>
                    {props.signedIn && (
                        ...
                        <div className={classes.search}>
                            ...
                            <InputBase
                                ...
                                placeholder="Search for Medical Suppliers"
                                classes={{
                                ...
                                style={{ background: 'rgba(0,0,0,0.9)' , color: '#5ce1e6', border: '1px solid #5ce1e6', fontFamily: 'Rajdhani', fontWeight: '500', fontSize: '1em',}}
                            />
            ...
            {props.signedIn && (
                ...
                >
                    ...
                    <div className={classes.drawerHeader} >
                        <h5 style={{color: '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '1.2em',}}>RONA <span  style={{color : '#fe0023', fontFamily: 'Rajdhani', fontWeight: '100', fontSize: '1em', }}>  GOD'S EYE EDITION </span></h5>
                        <IconButton onClick={handleDrawerClose} style={{color: '#5ce1e6'}}>
                            <ChevronLeftIcon />
                        </IconButton>
                    </div>
                    </div>
                    ...
                    <div className="profile-header dott" style={{ backgroundColor: 'rgba(0,0,0,0.5)', margin: '0' }}>
                        <span style={{color: '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '1em',}}>YOUR PROFILE</span>
                    </div>
                    {/*<Divider />*/}
                    ...
                    <div className="profile-img-wrapper dott" style={{ backgroundColor: 'rgba(0,0,0,0.5)', margin: '0' }}>
                        ...
                        <div>
                            <span className="profile-name" style={{color: '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '1em',}}>{props.user.name}</span>
                        </div>
                        <div>
                            <span className="profile-email" style={{color: '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '1em',}}>{props.user.email}</span>
                        </div>
                    </div>
                    <Divider />
                    <div className="profile-header dott" style={{ backgroundColor: 'rgba(0,0,0,0.5)', margin: '0' }}>
                        <span style={{color: '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '1em',}}>Settings</span>
                    </div>
                    {/*<Divider />*/}
                    <div className="profile-padding dott" style={{ backgroundColor: 'rgba(0,0,0,0.5)', margin: '0' }}>
                        <span style={{color: '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '1em',}}>Update your profile picture</span>
                        <TextField value={imgUrl} onChange={handleUrlChange} style={{ width: '80%',color: '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '1em', }} label="Image link" variant="standard" style={{color: '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '1em',}}/>
                        <IconButton color="primary" disabled={saveDisabled} onClick={handleUpdatePic} aria-label="save">
                            {saveLoading && <CircularProgress style={{ color: "#5ce1e6" }} size={20} />}
                    ...
                    <Divider />
                    <div className="profile-padding dott" style={{ backgroundColor: 'rgba(0,0,0,0.5)', margin: '0' }}>
                        <span style={{color: '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '1em', textAlign: 'center'}}>Update your password</span>
                        <form style={{color: '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '1em',}}>
                            <TextField value={password.currentPw} type="password" name="currentPw" onChange={handlePasswordChange} style={{ width: '95%',color: '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '1em', }} label="Current password" variant="standard" />
                            <TextField value={password.newPw} type="password" name="newPw" onChange={handlePasswordChange} style={{ width: '95%', color: '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '1em', }} label="New password" variant="standard" />
                            <TextField value={password.newPwConfirm} type="password" name="newPwConfirm" onChange={handlePasswordChange} style={{ width: '95%', color: '#5ce1e6', fontFamily: 'Rajdhani', fontWeight: '700', fontSize: '1em', }} label="Confirm new password" />
